...
@Service
public class WithdrawalTypeStrategy extends TransactionOperationService {

    public WithdrawalTypeStrategy(PaymentProviderCallbackRepository paymentProviderCallbackRepository,
